...
const (
	UserService_CreateNewUserAccount_FullMethodName = "/yasuo.UserService/CreateNewUserAccount"
	UserService_GetUserProfile_FullMethodName       = "/yasuo.UserService/GetUserProfile"
	UserService_DeleteUserAccount_FullMethodName    = "/yasuo.UserService/DeleteUserAccount"
)
...
func (c *userServiceClient) CreateNewUserAccount(ctx context.Context, in *CreateNewUserAccountRequest, opts ...grpc.CallOption) (*CreateNewUserAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_CreateNewUserAccount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_CreateNewUserAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_CreateNewUserAccount_FullMethodName,
	}
